...
type MonthlyAdjustedTimeSeriesService interface {
	...
	Get(options *MonthlyAdjustedTimeSeriesOptions) (*MonthlyAdjustedTimeSeries, error)
	Sync(symbol string, db database.SQLClient) error
}

type MonthlyAdjustedTimeSeriesOptions struct {
	Symbol string
}

func newMonthlyAdjustedTimeSeriesOptions(symbol string) *MonthlyAdjustedTimeSeriesOptions {
	return &MonthlyAdjustedTimeSeriesOptions{Symbol: symbol}
}

func (o *MonthlyAdjustedTimeSeriesOptions) ToQueryString() string {
...
func (s *monthlyAdjustedTimeSeriesServicer) Get(options *MonthlyAdjustedTimeSeriesOptions) (*MonthlyAdjustedTimeSeries, error) {
